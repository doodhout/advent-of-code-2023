...
public class Day1ATests {
	...
	@Test
	public void testEmptyStringGivesCalibrationValueZero() {
		assertThat(day1a.calculateCalibrationValue("")).isEqualTo(0);
	}

	@Test
	public void testSingleLineInput1text1GivingSum11() {
		assertThat(day1a.calculateCalibrationValue("1text1")).isEqualTo(11);
	}

	@Test
	public void testDoubleLineInput() {
		assertThat(day1a.calculateCalibrationValue("1text1" + System.lineSeparator() + "2text7")).isEqualTo(38);
	}

	@Test
	public void testSmallExamlpleFromAdventOfCode() {
		String smallExample = """
				1abc2
				pqr3stu8vwx
				a1b2c3d4e5f
				treb7uchet
				""";
		assertThat(day1a.calculateCalibrationValue(smallExample)).isEqualTo(142);
	}

	@Test
	public void testActualCalibrationTextFromAdventOfCode() {
